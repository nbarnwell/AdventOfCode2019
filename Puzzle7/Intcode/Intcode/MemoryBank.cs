namespace Intcode 
{
    ...
    public class MemoryBank
    {
        ...
        public int GetValueImmediate(int address)
        {
            ...
            Console.WriteLine("GetValueImmediate(address: {0}) = {1}", address, value);
            return value;
        }

        public void SetValueImmediate(int address, int value)
        {
            Console.WriteLine("SetValueImmediate(address: {0}, value: {1})", address, value);
        ...
        public void SetValueByLocation(int address, int value)
        {
            ...
            Console.WriteLine("SetValueByLocation(address: {0}, dereferencedAddress: {1}, value: {2}", address, dereferencedAddress, value);
        ...
        public int GetValueByLocation(int address)
        {
            ...
            Console.WriteLine("GetValueByLocation(address: {0}, dereferencedAddress: {1}) = {2}", address, dereferencedAddress, result);
            return result;
        }
